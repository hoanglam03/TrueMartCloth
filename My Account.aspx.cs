    ...
    public partial class My_Account : System.Web.UI.Page
    {
        ...
        private void showList()
        {
            if (Session["userlogin"] != null)
            {
                ...
                string sqlCon = @"Data Source=ChuVanQuy;Initial Catalog=JQKShop;Integrated Security=True";
        ...
        {
            String mycon = @"Data Source=ChuVanQuy;Initial Catalog=JQKShop;Integrated Security=True";
